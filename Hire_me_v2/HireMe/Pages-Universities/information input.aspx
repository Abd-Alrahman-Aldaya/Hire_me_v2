...
<body>
    ...
    <div class="container ">
        ...
        <div class="bag text-center container" id="rakba" style="display:none;">
            <div class="d3">
                <select id="sele_cho_vac" name="select_chs_vacancy" class="select1 form-control text-center" size="8" runat="server"></select>
            </div>

            <div class="d2">
                <asp:Button ID="Button1" runat="server" class="bt1" Text="Button" OnClick="Button1_Click" /><br />
                <button class="bt1"><<</button><br />
                <button class="bt1">>></button>
            </div>
            <div class="d1">
                <select id="sele_vac" name="select_vacancy" class="select2 form-control text-center" size="8" runat="server">
                    <option class="opt1" value="mastr" runat="server">mastr</option>
                    <option class="opt1" value="bakaloruas" runat="server">bakaloruas</option>
                    <option class="opt1" value="bakaloruas" runat="server">bakaloruas</option>
                    <option class="opt1" value="bakaloruas" runat="server">bakaloruas</option>
